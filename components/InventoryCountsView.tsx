        ...
        <Modal isOpen={isOpen} onClose={onClose} title={"Yangi inventarizatsiya"} size="5xl">
            <form onSubmit={handleFormSubmit} className="space-y-6">
                    ...
                    <div className="overflow-x-auto max-h-[50vh]">
                        <table className="w-full text-sm">
                            <thead className="bg-slate-50 sticky top-0">
                                <tr>
                                    <th className="px-4 py-2 text-left font-medium text-slate-600 w-2/5">Mahsulot</th>
                                    <th className="px-4 py-2 text-left font-medium text-slate-600">Rejadagi (tizim)</th>
                                    <th className="px-4 py-2 text-left font-medium text-slate-600">Haqiqiy (sanoq)</th>
                                ...
                                {items.map((item, index) => {
                                    ...
                                    return (
                                        <tr key={index} className="border-b">
                                            ...
                                            <td className="p-2">{item.planned_quantity} {product?.unit}</td>
                                            <td className="p-2">
                ...
                <div className="flex justify-end gap-3 pt-4 border-t">
                    ...
                    <button type="submit" className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Hujjatni yaratish</button>
                </div>
            </form>
        </Modal>
    );
